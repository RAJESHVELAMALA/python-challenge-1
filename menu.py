...
order = []
#order = [{"item_name": "", "item_price": 0, "quantity": 0}]
...
for item in order:
    ...
    print(f"{item_name}{item_spaces}| ${item['item_price']} | {item['quantity']}")


# 11. Calculate the cost of the order using list comprehension
# Multiply the price by quantity for each item in the order list, then sum()
# and print the prices.
total_cost = sum([item["item_price"] * item["quantity"] for item in order])
print("\n","-"*40)
